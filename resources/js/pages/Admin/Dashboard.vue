...
import { Calendar1Icon, EyeIcon, File, Folder, UserCheck, Users } from 'lucide-vue-next';
                            ...
                            <TableCell>
                                <div class="space-y-3">
                                    ...
                                    <Accordion type="single" collapsible>
                                        <AccordionItem value="dates" class="border rounded-md">
                                            <Button variant="ghost" size="sm" class="w-full justify-start" as-child>
                                                <AccordionTrigger class="text-[12px] flex items-center gap-2">
